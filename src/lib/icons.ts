...
const ICONS: Record<string, string> = {
  ...
  cloud: '<path d="M5.4 14.2h7.4a3 3 0 0 0 .3-6 4.2 4.2 0 0 0-8.1 1.1 2.5 2.5 0 0 0 .4 4.9Z"/>',
  'cloud-sun': '<path d="M6.5 3.2v1M2.9 6.8h1M4 4.3l.7.7M9.9 4.3l-.7.7"/><path d="M4.9 8.3a2.4 2.4 0 0 1 4.2-1.9"/><path d="M6.7 15h6.3a2.6 2.6 0 0 0 .2-5.2 3.6 3.6 0 0 0-6.9 1 2.1 2.1 0 0 0 .4 4.2Z"/>',
  'cloud-moon': '<path d="M9.6 5.9A2.9 2.9 0 0 1 6 2.6a3.1 3.1 0 0 0-2.6 4.6"/><path d="M6.7 15h6.3a2.6 2.6 0 0 0 .2-5.2 3.6 3.6 0 0 0-6.9 1 2.1 2.1 0 0 0 .4 4.2Z"/>',
  rain: '<path d="M5.4 11.2h7.4a3 3 0 0 0 .3-6 4.2 4.2 0 0 0-8.1 1.1 2.5 2.5 0 0 0 .4 4.9Z"/><path d="M6.5 13.4l-.7 1.8M9.3 13.4l-.7 1.8M12.1 13.4l-.7 1.8"/>',
  snow: '<path d="M5.4 11.2h7.4a3 3 0 0 0 .3-6 4.2 4.2 0 0 0-8.1 1.1 2.5 2.5 0 0 0 .4 4.9Z"/><path d="M6.4 14.3h.01M9 15.2h.01M11.6 14.3h.01" stroke-width="2.2"/>',
  storm: '<path d="M5.4 11.2h7.4a3 3 0 0 0 .3-6 4.2 4.2 0 0 0-8.1 1.1 2.5 2.5 0 0 0 .4 4.9Z"/><path d="M9.6 11.6l-1.6 2.3h2.2l-1.5 2.3"/>',
  fog: '<path d="M3 7.5h12M4.5 10.5h9M3 13.5h12"/>',
