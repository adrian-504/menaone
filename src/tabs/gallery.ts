...
function renderGallery(): void {
  ...
  el.innerHTML = [
    ...
    section('Buttons', row(`<button class="btn-primary">Primary</button><button class="btn-secondary">Secondary</button><button class="btn-danger">Danger</button><button class="btn-sm">Small</button><button class="btn-primary" disabled>Disabled</button>`)),
