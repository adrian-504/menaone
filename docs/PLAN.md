...
| | |
|---|---|
| Runs on | One Mac, one user. Schema 34. Data and backups stay on that Mac |
...
- **A quiet period, not a workstream.** The owner uses the app daily; what irritates gets fixed; the four items above get chipped at. No new modules until something above unblocks.
